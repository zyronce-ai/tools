          ...
          <motion.div {...fadeUp} className="text-center mb-12">
            ...
            <div className="flex items-center justify-center gap-3 mt-8">
              ...
              <button onClick={() => setYearly(!yearly)} className={`relative w-14 h-7 rounded-full transition-colors ${yearly ? "bg-orange-500" : "bg-gray-300"}`}>
                <div className={`absolute top-0.5 w-6 h-6 bg-white rounded-full shadow-md transition-transform ${yearly ? "translate-x-7.5 left-0" : "left-0.5"}`} style={{ transform: yearly ? 'translateX(28px)' : 'translateX(2px)' }} />
              </button>
